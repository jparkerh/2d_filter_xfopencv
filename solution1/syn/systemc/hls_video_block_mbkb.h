...
#ifndef __hls_video_block_mbkb__HH__
#define __hls_video_block_mbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_video_block_mbkb) {
    ...
    SC_CTOR(hls_video_block_mbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
