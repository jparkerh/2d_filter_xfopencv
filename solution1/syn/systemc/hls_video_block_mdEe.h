...
#ifndef __hls_video_block_mdEe__HH__
#define __hls_video_block_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_video_block_mdEe) {
    ...
    SC_CTOR(hls_video_block_mdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
