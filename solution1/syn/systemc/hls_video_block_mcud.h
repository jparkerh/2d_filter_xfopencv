...
#ifndef __hls_video_block_mcud__HH__
#define __hls_video_block_mcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_video_block_mcud) {
    ...
    SC_CTOR(hls_video_block_mcud):  simcore_mac_0_U ("simcore_mac_0_U") {
