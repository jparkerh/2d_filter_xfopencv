...
set ::env(LD_LIBRARY_PATH) /proj/gsd/vivado/Vivado/2018.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /proj/gsd/vivado/Vivado/2018.2/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /proj/gsd/vivado/Vivado/2018.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /proj/gsd/vivado/Vivado/2018.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /proj/gsd/vivado/Vivado/2018.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_video_block.autotvin.dat"
	set constFileTvOut       "hls_video_block.autotvout.dat"
	set constFileHdlTvIn     "hls_video_block.autohdltvin.dat"
	set constFileHdlTvOut    "hls_video_block.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
