...
$(ObjDir)/test_hls_video_block.cpp_pre.cpp.tb.o : test_hls_video_block.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_hls_video_block.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/hls_video_block.cpp_pre.cpp.tb.o : hls_video_block.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling hls_video_block.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
