...
reg   [0:0] exitcond_i_reg_446;
reg   [0:0] brmerge_i_reg_455;
...
reg   [10:0] t_V_2_reg_212;
reg   [0:0] eol_i_reg_223;
reg   [0:0] eol_reg_235;
reg   [23:0] axi_data_V_1_i_reg_246;
reg   [0:0] axi_last_V_3_i_reg_293;
reg   [23:0] axi_data_V_3_i_reg_305;
reg   [10:0] img_rows_V_read_reg_407;
reg    ap_block_state1;
reg   [11:0] img_cols_V_read_reg_412;
reg   [23:0] tmp_data_V_reg_417;
reg   [0:0] tmp_last_V_reg_425;
wire   [0:0] exitcond2_i_fu_340_p2;
wire    ap_CS_fsm_state4;
wire   [9:0] i_V_fu_345_p2;
reg   [9:0] i_V_reg_441;
wire   [0:0] exitcond_i_fu_355_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_predicate_op73_read_state6;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [10:0] j_V_fu_360_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [0:0] brmerge_i_fu_369_p2;
...
reg   [0:0] ap_phi_mux_eol_2_i_phi_fu_285_p4;
reg   [0:0] axi_last_V1_i_reg_181;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state3;
reg   [23:0] axi_data_V1_i_reg_191;
reg   [9:0] t_V_reg_201;
reg   [0:0] ap_phi_mux_eol_i_phi_fu_227_p4;
reg   [0:0] ap_phi_mux_axi_last_V_2_i_phi_fu_262_p4;
reg   [23:0] ap_phi_mux_p_Val2_s_phi_fu_274_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_257;
wire   [23:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_270;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_i_fu_110;
wire   [10:0] t_V_cast_i_fu_336_p1;
wire   [11:0] t_V_2_cast_i_fu_351_p1;
wire   [0:0] tmp_user_V_fu_327_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
reg    ap_idle_pp2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond2_i_fu_340_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_fu_355_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond2_i_fu_340_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_phi_mux_eol_2_i_phi_fu_285_p4 == 1'd1) & (1'b0 == ap_block_pp2_stage0_subdone) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
            ap_enable_reg_pp2_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_446 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((eol_2_i_reg_282 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_355_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_i_fu_110 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_355_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((eol_2_i_reg_282 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op73_read_state6 == 1'b1)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_282 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_i_reg_455 == 1'd0) & (exitcond_i_reg_446 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if (((exitcond2_i_fu_340_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_529)) begin
        if ((brmerge_i_reg_455 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_i_phi_fu_262_p4 = eol_reg_235;
        end else if ((brmerge_i_reg_455 == 1'd0)) begin
...
always @ (*) begin
    if (((eol_2_i_reg_282 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    if (((exitcond_i_reg_446 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_327_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_327_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op73_read_state6 == 1'b1)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op73_read_state6 == 1'b1)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op73_read_state6 == 1'b1)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((eol_2_i_reg_282 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((eol_2_i_reg_282 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op73_read_state6 == 1'b1)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_446 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)));
end

assign ap_block_state8_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_pp2_stage0_iter1 = ((eol_2_i_reg_282 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end

always @ (*) begin
    ap_condition_529 = ((exitcond_i_reg_446 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_257 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_270 = 'bx;

always @ (*) begin
    ap_predicate_op73_read_state6 = ((brmerge_i_reg_455 == 1'd0) & (exitcond_i_reg_446 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_i_fu_369_p2 = (sof_1_i_fu_110 | ap_phi_mux_eol_i_phi_fu_227_p4);

assign exitcond2_i_fu_340_p2 = ((t_V_cast_i_fu_336_p1 == img_rows_V_read_reg_407) ? 1'b1 : 1'b0);

assign exitcond_i_fu_355_p2 = ((t_V_2_cast_i_fu_351_p1 == img_cols_V_read_reg_412) ? 1'b1 : 1'b0);

assign i_V_fu_345_p2 = (t_V_reg_201 + 10'd1);

assign img_cols_V_out_din = img_cols_V_dout;

assign img_data_stream_0_V_din = ap_phi_mux_p_Val2_s_phi_fu_274_p4[7:0];

assign img_data_stream_1_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_274_p4[15:8]}};

assign img_data_stream_2_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_274_p4[23:16]}};

assign img_rows_V_out_din = img_rows_V_dout;

assign j_V_fu_360_p2 = (t_V_2_reg_212 + 11'd1);

assign start_out = real_start;

assign t_V_2_cast_i_fu_351_p1 = t_V_2_reg_212;

assign t_V_cast_i_fu_336_p1 = t_V_reg_201;

assign tmp_user_V_fu_327_p1 = AXI_video_strm_V_user_V_0_data_out;
